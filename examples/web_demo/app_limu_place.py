...
class ImagenetClassifier(object):
    ...
    '''
    # here we use the place_cnn for default args
    default_args = {
        'model_def_file': (
            '{}/models/places_cnn_mit/hybridCNN_deploy.prototxt'.format(REPO_DIRNAME)),
        'pretrained_model_file': (
            '{}/models/places_cnn_mit/hybridCNN_iter_700000.caffemodel'.format(REPO_DIRNAME)),
        'mean_file': (
            '{}/models/places_cnn_mit/hybridCNN_mean.npy'.format(REPO_DIRNAME)),
        'class_labels_file': (
            '{}/data/ilsvrc12/synset_words.txt'.format(REPO_DIRNAME)),
        'place_labels_file': (
            '{}/models/places_cnn_mit/categoryIndex_hybridCNN.csv'.format(REPO_DIRNAME)),
        'bet_file': (
            '{}/data/ilsvrc12/imagenet.bet.pickle'.format(REPO_DIRNAME)),
    }
    ...
    def __init__(self, model_def_file, pretrained_model_file, mean_file,
                 raw_scale, class_labels_file, place_labels_file, bet_file, image_dim, gpu_mode):
        ...
        self.labels = read_labels_csv(place_labels_file, class_labels_file)
